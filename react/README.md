...
- update-uri reactive
  - când se modifică ceva React va compara reprezentarea internă a DOM-ului cu ceea ce a primit și va actualiza numai acele componente care s-au modificat
...
### Props (properties)
- one-way flow (date trimise de la un element părinte la copii)
...
- pentru a le modifica valoarea puteam folosi starea
...
- common pattern: event handlers definite ca metode ale clasei
  ...
  - pentru a le lega de this trebuie să facem acest bind care creează o copie a funcției primite
